...
import { requestVoiceChallenge } from '../demoguard/api';
...
interface Props {
  ...
  onComplete: (voice: DemoGuardVoiceSignal, diagnostic: VoiceDiagnosticsSafe | null, voiceB64: string | null, vocalRan: VocalRanSignal, voiceMimetype: string | null, voiceNonce: string | null, voiceChallengeId: string | null) => void;
